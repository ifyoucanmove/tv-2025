...
import { playCircle, pauseCircle, volumeHigh, volumeMute, expand, contract } from 'ionicons/icons';
...
export class VideoPlayerComponent implements OnInit, OnDestroy {
  constructor() {
    addIcons({ playCircle, pauseCircle, volumeHigh, volumeMute, expand, contract });
  }
  @Input() video: any;
